...
var DECL_VAR_LIKE = 1 << 1,
    DECL_LET_LIKE = DECL_VAR_LIKE << 1,
    DECL_CATCH = DECL_LET_LIKE << 1,
    DECL_PARAMS = DECL_CATCH << 1,
    DECL_FUNC = DECL_PARAMS << 1,
    DECL_STMT = DECL_FUNC << 1,
    DECL_EXPR = DECL_STMT << 1,
    DECL_CLASS = DECL_EXPR << 1,
    DECL_DUPE = DECL_CLASS << 1,
    DECL_EXPR_FUNC = DECL_FUNC|DECL_EXPR,
    DECL_PARAMS_FUNC = DECL_VAR_LIKE|DECL_PARAMS,
    DECL_STMT_FUNC = DECL_FUNC|DECL_STMT,
    DECL_PARAMS_CATCH = DECL_LET_LIKE|DECL_PARAMS,
    DECL_EXPR_CLASS = DECL_CLASS|DECL_EXPR,
    DECL_STMT_CLASS = DECL_CLASS|DECL_STMT,
    DECL_CLASS_FUNC = DECL_CLASS|DECL_FUNC;
