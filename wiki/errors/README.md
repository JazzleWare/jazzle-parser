...
Below is the list of early errors in the ECMAScript specification;

Checked ones are those that are caught by the parser:

#11.6.1.1
* IdentifierStart :: \ UnicodeEscapeSequence
  - [x] It is a Syntax Error if SV(UnicodeEscapeSequence) is none of "$", or "_", or the UTF16Encoding (10.1.1) of a code point matched by the UnicodeIDStart lexical grammar production.

* IdentifierPart :: \ UnicodeEscapeSequence
  - [x] It is a Syntax Error if SV(UnicodeEscapeSequence) is none of "$", or "_", or the UTF16Encoding (10.1.1) of either <ZWNJ> or <ZWJ>, or the UTF16Encoding of a Unicode code point that would be matched by the UnicodeIDContinue lexical grammar production.

#11.8.4.1
* UnicodeEscapeSequence :: u{ HexDigits }
  - [x] It is a Syntax Error if the MV of HexDigits > 1114111.

#11.8.5.1
* RegularExpressionFlags :: RegularExpressionFlags IdentifierPart
  - [x] It is a Syntax Error if IdentifierPart contains a Unicode escape sequence.

#12.1.1 Static Semantics: Early Errors
* BindingIdentifier : Identifier
  - [x] It is a Syntax Error if the code matched by this production is contained in strict mode code and the StringValue of Identifier is "arguments" or "eval".

*  IdentifierReference : yield
* BindingIdentifier : yield
* LabelIdentifier : yield
  - [x]  It is a Syntax Error if the code matched by this production is contained in strict mode code.

*  IdentifierReference [Yield] : Identifier
* BindingIdentifier [Yield] : Identifier
* LabelIdentifier [Yield] : Identifier
  - [x]  It is a Syntax Error if this production has a [Yield] parameter and StringValue of Identifier is "yield".

*  Identifier : IdentifierName but not ReservedWord
  - [x]  It is a Syntax Error if this phrase is contained in strict mode code and the StringValue of IdentifierName is: "implements", "interface", "let", "package", "private", "protected", "public", "static", or "yield".
  - [x] It is a Syntax Error if StringValue of IdentifierName is the same String value as the StringValue of any ReservedWord except for yield.
...
* PropertyDefinition : CoverInitializedName
  - [x] Always throw a Syntax Error if code matches this production.
...
* PrimaryExpression : RegularExpressionLiteral
  - [x]  It is a Syntax Error if BodyText of RegularExpressionLiteral cannot be recognized using the goal symbol Pattern of the ECMAScript RegExp grammar specified in 21.2.1.
  - [x]  It is a Syntax Error if FlagText of RegularExpressionLiteral contains any code points other than "g", "i", "m", "u", or "y", or if it contains the same code point more than once.

#12.2.10.1
* PrimaryExpression : CoverParenthesizedExpressionAndArrowParameterList
  - [x]  It is a Syntax Error if the lexical token sequence matched by CoverParenthesizedExpressionAndArrowParameterList cannot be parsed with no tokens left over using ParenthesizedExpression as the goal symbol.
  - [x]  All Early Errors rules for ParenthesizedExpression and its derived productions also apply to CoveredParenthesizedExpression of CoverParenthesizedExpressionAndArrowParameterList.

#12.4.1
*  PostfixExpression :
  LeftHandSideExpression++
  LeftHandSideExpression--
  - [x]  It is an early Reference Error if IsValidSimpleAssignmentTarget of LeftHandSideExpression is false.

#12.5.1 Static Semantics: Early Errors
* UnaryExpression :
  -- UnaryExpression
  ++ UnaryExpression
  - [x]  It is an early Reference Error if IsValidSimpleAssignmentTarget of UnaryExpression is false.

#12.5.4.1
*  UnaryExpression : delete UnaryExpression
  - [x]  It is a Syntax Error if the UnaryExpression is contained in strict mode code and the derived UnaryExpression is PrimaryExpression : IdentifierReference.
  - [x]  It is a Syntax Error if the derived UnaryExpression is PrimaryExpression : CoverParenthesizedExpressionAndArrowParameterList and CoverParenthesizedExpressionAndArrowParameterList ultimately derives a phrase that, if used in place of UnaryExpression, would produce a Syntax Error according to these rules. This rule is recursively applied.
**  NOTE
...
*  AssignmentExpression : LeftHandSideExpression = AssignmentExpression
  - [x]  It is a Syntax Error if LeftHandSideExpression is either an ObjectLiteral or an ArrayLiteral and the lexical token sequence matched by LeftHandSideExpression cannot be parsed with no tokens left over using AssignmentPattern as the goal symbol.
  - [x]  It is an early Reference Error if LeftHandSideExpression is neither an ObjectLiteral nor an ArrayLiteral and IsValidSimpleAssignmentTarget of LeftHandSideExpression is false.
...
*  AssignmentProperty : IdentifierReference Initializer opt
  - [x]  It is a Syntax Error if IsValidSimpleAssignmentTarget of IdentifierReference is false.

*  DestructuringAssignmentTarget : LeftHandSideExpression
  - [x]  It is a Syntax Error if LeftHandSideExpression is either an ObjectLiteral or an ArrayLiteral and if the lexical token sequence matched by LeftHandSideExpression cannot be parsed with no tokens left over using AssignmentPattern as the goal symbol.
  - [x]  It is a Syntax Error if LeftHandSideExpression is neither an ObjectLiteral nor an ArrayLiteral and IsValidSimpleAssignmentTarget(LeftHandSideExpression) is false.
...
* ContinueStatement : continue LabelIdentifier ;
  - [x]  It is a Syntax Error if this production is not nested, directly or indirectly (but not crossing function boundaries), within an IterationStatement.

#13.9.1
* BreakStatement : break ;
  - [x]  It is a Syntax Error if this production is not nested, directly or indirectly (but not crossing function boundaries), within an IterationStatement or a SwitchStatement.

#13.11.1
*  WithStatement : with ( Expression ) Statement
  - [x]  It is a Syntax Error if the code that matches this production is contained in strict code.
  - [ ]  It is a Syntax Error if IsLabelledFunction(Statement) is true.
...
*  LabelledItem : FunctionDeclaration
  - [x]  It is a Syntax Error if any source text matches this rule.
...
* FunctionExpression : function BindingIdentifier opt ( FormalParameters ) { FunctionBody }
  - [x]  If the source code matching this production is strict code, the Early Error rules for StrictFormalParameters : FormalParameters are applied.
  - [x]  If the source code matching this production is strict code, it is a Syntax Error if BindingIdentifier is the IdentifierName eval or the IdentifierName arguments.
  - [ ]  It is a Syntax Error if any element of the BoundNames of FormalParameters also occurs in the LexicallyDeclaredNames of FunctionBody.
  - [x]  It is a Syntax Error if FormalParameters Contains SuperProperty is true.
  - [x]  It is a Syntax Error if FunctionBody Contains SuperProperty is true.
  - [x]  It is a Syntax Error if FormalParameters Contains SuperCall is true.
  - [x]  It is a Syntax Error if FunctionBody Contains SuperCall is true.
...
*  StrictFormalParameters : FormalParameters
  - [x]  It is a Syntax Error if BoundNames of FormalParameters contains any duplicate elements.
*  FormalParameters : FormalParameterList
  - [x]  It is a Syntax Error if IsSimpleParameterList of FormalParameterList is false and BoundNames of FormalParameterList contains any duplicate elements.
...
* FunctionBody : FunctionStatementList
  ...
  - [x]  It is a Syntax Error if ContainsDuplicateLabels of FunctionStatementList with argument « » is true.
  - [x]  It is a Syntax Error if ContainsUndefinedBreakTarget of FunctionStatementList with argument « » is true.
  - [x]  It is a Syntax Error if ContainsUndefinedContinueTarget of FunctionStatementList with arguments « » and « » is true.
...
*  ArrowParameters [Yield] : CoverParenthesizedExpressionAndArrowParameterList [?Yield]
  - [x]  (the error, for cases like `function *l() { (yield=12)=>12; }` is not 'invalid argument' though) If the [Yield] grammar parameter is present on ArrowParameters, it is a Syntax Error if the lexical token sequence matched by CoverParenthesizedExpressionAndArrowParameterList [?Yield] cannot be parsed with no tokens left over using ArrowFormalParameters [Yield] as the goal symbol.
  - [x]  If the [Yield] grammar parameter is not present on ArrowParameters, it is a Syntax Error if the lexical token sequence matched by CoverParenthesizedExpressionAndArrowParameterList [?Yield] cannot be parsed with no tokens left over using ArrowFormalParameters as the goal symbol.
  - [x]  All early errors rules for ArrowFormalParameters and its derived productions also apply to CoveredFormalsList of CoverParenthesizedExpressionAndArrowParameterList [?Yield] .

#14.3.1
*  MethodDefinition : PropertyName ( StrictFormalParameters ) { FunctionBody }
  - [x]  It is a Syntax Error if any element of the BoundNames of StrictFormalParameters also occurs in the LexicallyDeclaredNames of FunctionBody.
*  MethodDefinition : set PropertyName ( PropertySetParameterList ){ FunctionBody }
  - [x]  It is a Syntax Error if BoundNames of PropertySetParameterList contains any duplicate elements.
  - [x]  It is a Syntax Error if any element of the BoundNames of PropertySetParameterList also occurs in the LexicallyDeclaredNames of FunctionBody.

#14.4.1 Static Semantics: Early Errors
* GeneratorMethod : * PropertyName ( StrictFormalParameters ) { GeneratorBody }
  - [x]  It is a Syntax Error if HasDirectSuper of GeneratorMethod is true.
  - [x]  It is a Syntax Error if StrictFormalParameters Contains YieldExpression is true.
...
*  GeneratorDeclaration : function * BindingIdentifier ( FormalParameters ) { GeneratorBody }
  - [x]  It is a Syntax Error if HasDirectSuper of GeneratorDeclaration is true.
*  GeneratorExpression : function * BindingIdentifier opt ( FormalParameters ) { GeneratorBody }
  - [x]  It is a Syntax Error if HasDirectSuper of GeneratorExpression is true.
*  GeneratorDeclaration : function * BindingIdentifier ( FormalParameters ) { GeneratorBody }
*  GeneratorExpression : function * BindingIdentifier opt ( FormalParameters ) { GeneratorBody }
  - [x]  If the source code matching this production is strict code, the Early Error rules for StrictFormalParameters : FormalParameters are applied.
  - [x]  If the source code matching this production is strict code, it is a Syntax Error if BindingIdentifier is the IdentifierName eval or the IdentifierName arguments.
  ...
  - [x]  It is a Syntax Error if FormalParameters Contains YieldExpression is true.
  - [x]  It is a Syntax Error if FormalParameters Contains SuperProperty is true.
  - [x]  It is a Syntax Error if GeneratorBody Contains SuperProperty is true.
...
* ClassBody : ClassElementList
  - [x]  It is a Syntax Error if PrototypePropertyNameList of ClassElementList contains more than one occurrence of " constructor " .
*  ClassElement : MethodDefinition
  - [x]  It is a Syntax Error if PropName of MethodDefinition is not " constructor " and HasDirectSuper of MethodDefinition is true.
  - [x]  It is a Syntax Error if PropName of MethodDefinition is " constructor " and SpecialMethod of MethodDefinition is true.
* ClassElement : static MethodDefinition
  - [x]  It is a Syntax Error if HasDirectSuper of MethodDefinition is true.
  - [x]  It is a Syntax Error if PropName of MethodDefinition is " prototype " .
...
*  ScriptBody : StatementList
  ...
  - [x]  It is a Syntax Error if ContainsDuplicateLabels of StatementList with argument « » is true.
  - [x]  It is a Syntax Error if ContainsUndefinedBreakTarget of StatementList with argument « » is true.
  - [x]  It is a Syntax Error if ContainsUndefinedContinueTarget of StatementList with arguments « » and « » is true.
...
* ExportDeclaration : export ExportClause ;
  - [x]  For each IdentifierName n in ReferencedBindings of ExportClause: It is a Syntax Error if StringValue of n is a ReservedWord or if the StringValue of n is one of: "implements", "interface", "let", "package", "private", "protected", "public", "static", or "yield".
